...
if (isset($_POST["report_btn"])) {
  ...
  if ($rows) 
    ...
    $html .= '</tbody></table></body></html>';
      ...
      $mpdf->SetHTMLHeader('<div style="text-align: center; font-weight: bold;"><h3>Daily Work Report of DEV IT Employees</h3>
        </div>');      
      $mpdf->WriteHTML($html);
      $mpdf->SetHTMLFooter('
        <table width="100%">
...
if (isset($_POST["report_btn2"])) {
  ...
  if ($rows) 
    ...
    $html .= '</tbody></table></body></html>';
      require_once __DIR__ . '/vendor/autoload.php';
      $mpdf = new \Mpdf\Mpdf(['format' => 'A4-L']);
      $mpdf->SetHTMLHeader('<div style="text-align: center; font-weight: bold;"><h3>Daily Work Assigned Report of DEV IT Employees</h3>
        </div>');      
      $mpdf->WriteHTML($html);
      $mpdf->SetHTMLFooter('
        <table width="100%">
